...
{cyan} =============================================
{yellow}|  Best Hacking Tool X By Omindu Anjana |
{cyan} ============================================={nc}''')
...
{red}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
{yellow}       [+] Tool Name :- {green}Dragon Tech Tool-X
{yellow}       [+] Latest Update :- {green}03/4/2022.\033[1;m
{yellow}       [+] Tools :- {green}total {total} tools.\033[1;m
{yellow}       [+] Tools Owner :- {green}OMINDU ANJANA.\033[1;m
{yellow}       [+] Owner Nik Name :- {red}Black Alpha.\033[1;31m
...
{green}|______________ Updating Tool-X ______________|
 {yellow}============================================={nc}""")
  ...
  def installing(self):
    print (f"""{yellow} =============================================
{green}|________________ Installing Tool-X _________________|
 {yellow}============================================={nc}""")
