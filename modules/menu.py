        ...
        if system.connection():
          ...
          if system.sudo != None:
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system(system.sudo+" git clone https://github.com/hackersblackhatlk/Tool-X.git "+system.home+"/Tool-X")
            if os.path.exists(system.home+"/Tool-X/install.aex"):
              ...
              if os.path.exists(system.bin+"/Tool-X") and os.path.exists(system.conf_dir+"/Tool-X"):
                os.system("clear")
                logo.updated()
                cmd=input(f"{blue}Dragon Tech Tool X{nc}@{blue}space {yellow}$ {nc}")
              else:
                os.system("clear")
                logo.update_error()
                cmd=input(f"{blue}Dragon Tech Tool X{nc}@{blue}space {yellow}$ {nc}")
          ...
          os.system("clear")
          logo.nonet()
          tmp=input(f"{blue}Dragon Tech Tool X{nc}@{blue}space {yellow}$ {nc}")
